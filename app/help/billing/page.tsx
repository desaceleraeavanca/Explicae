  ...
  return (
    <div className="container mx-auto max-w-4xl py-8 px-4">
      ...
      <div className="hidden md:flex items-center gap-2 text-sm text-muted-foreground mb-4">
        <Breadcrumbs items={[{ label: "Início", href: "/" }, { label: "Ajuda", href: "/help" }, { label: "Cobrança & Planos" }]} />
      </div>
      ...
      <div className="rounded-2xl border bg-card shadow-sm overflow-hidden mb-8">
        <div className="px-6 py-8 text-center">
          <div className="inline-flex items-center gap-2 rounded-lg border px-3 py-1 text-sm text-muted-foreground mb-3 bg-background">
            ...
            <span>Cobrança & Planos</span>
          </div>
          <h1 className="text-3xl font-bold tracking-tight">Planos, pagamentos e benefícios</h1>
          <p className="mt-2 text-muted-foreground leading-relaxed">
            Tudo o que você precisa saber para escolher e gerenciar sua assinatura.
          </p>
        </div>
      </div>
...
const articles = allArticles.filter((a) => a.category === "billing");